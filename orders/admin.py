...
class OrderAdmin(admin.ModelAdmin):
    ...
    list_filter = ['user','paymentMethod','isPaid','totalPrice','amountPaid','paidAt','uuid','status']
    list_display = ['user','paymentMethod','isPaid','totalPrice','amountPaid','paidAt','uuid','deliveredAt','status']
